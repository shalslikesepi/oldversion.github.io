...
<span style="color:mediumblue">Education</span>
======
...
<span style="color:mediumblue">Publications</span>
======
  <ul>{% for post in site.publications %}
    {% include archive-single-cv.html %}
  {% endfor %}</ul>

<span style="color:mediumblue">Research Experience</span>
======
...
<span style="color:mediumblue">Talks</span>
======
  <ul>{% for post in site.talks %}
    {% include archive-single-talk-cv.html %}
  {% endfor %}</ul>    
  
<span style="color:mediumblue">Skills</span>
======
* Data analysis  
  * SAS
  * R
...
<span style="color:mediumblue">Service and Leadership</span>
======
...
<span style="color:mediumblue">Non-Academic Employment</span>  
======  
