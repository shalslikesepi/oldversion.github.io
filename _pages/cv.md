...
<span style="color:turquoise">Education</span>
======
...
<span style="color:turquoise">Publications</span>
======
  <ul>{% for post in site.publications %}
    {% include archive-single-cv.html %}
  {% endfor %}</ul>

<span style="color:turquoise">Research Experience</span>
======
...
<span style="color:turquoise">Talks</span>
======
  <ul>{% for post in site.talks %}
    {% include archive-single-talk-cv.html %}
  {% endfor %}</ul>    
  
<span style="color:turquoise">Skills</span>
======
* Data analysis  
  * SAS
  * R
...
<span style="color:turquoise">Service and Leadership</span>
======
...
<span style="color:turquoise">Non-Academic Employment</span>  
======  
